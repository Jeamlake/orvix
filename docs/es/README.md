# Documentación de ORVIX

[English](../en/README.md) | [Español](README.md)

- [Arquitectura](architecture/overview.md)
- [Compatibilidad de plataformas](platform/compatibility.md)
...
- [Registros de decisiones de arquitectura](adr/0012-cross-platform-native-capture.md)

Documentos generales del repositorio:

- [Descripción del proyecto](../../README.es.md)
